                    ...
                    <div className="flex gap-3 flex-wrap">
                      {ACCENT_SWATCHES.map(s => (
                        <button key={s.id} onClick={() => update("accentColor", s.id)} title={s.label}
                          className={cn("flex flex-col items-center gap-1.5 rounded-xl p-2.5 transition-all",
                ...
                <CardContent className="pt-5 space-y-5">
                  ...
                  <div>
                    ...
                    <Select value={settings.defaultCapSize} onValueChange={v => update("defaultCapSize", v)}>
                      <SelectTrigger className="w-40 bg-muted/40 border-border/60"><SelectValue /></SelectTrigger>
                      <SelectContent>
              ...
              <Card className="border-border/60">
                <CardContent className="pt-5 space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-3">Filters which pick signals are shown to you</p>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-3">Hide picks below this confidence score</p>
                  ...
                  {/* Default num picks */}
                  <div>
                    <p className="text-sm font-medium mb-1">Default Picks to Display</p>
                    <p className="text-xs text-muted-foreground mb-3">How many top picks to show per run result</p>
                    <div className="flex gap-2">
                      {[5, 10, 15, 20].map(n => (
                        <button key={n} onClick={() => update("defaultNumPicks", n)}
                          className={cn("rounded-lg border px-4 py-1.5 text-sm font-medium transition-all",
              ...
              <Card className="border-border/60">
                <CardContent className="pt-5 space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-3">Initial time range when opening a stock's price chart</p>
                    <div className="flex gap-1.5 flex-wrap">
                      {(["1mo", "3mo", "6mo", "1y"] as const).map(p => (
                        <button key={p} onClick={() => update("defaultChartPeriod", p)}
                          className={cn("rounded-lg border px-4 py-1.5 text-xs font-medium transition-all",
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-3">How stock cards are displayed in pick results</p>
                    <div className="grid grid-cols-2 gap-2">
                      {([
            ...
            <Section title="Privacy & Data" desc="Manage your data and history">
              ...
              <Card className="border-border/60">
                <CardContent className="pt-5 space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">Download all your saved picks as a CSV file.</p>
              ...
              <Card className="border-border/60 border-destructive/20">
                <CardContent className="pt-5 space-y-3">
                  ...
                  {confirmClear ? (
                    ...
                    <Button size="sm" variant="outline" onClick={() => setConfirmClear(true)} className="gap-2 border-destructive/40 text-destructive hover:bg-destructive/10 hover:text-destructive">
                ...
                <CardContent className="space-y-4">
                  ...
                  {runsLimit > 0 && runsLimit < 9999 && (
                    <div>
                      ...
                      {runsUsed >= runsLimit && <p className="mt-1.5 text-xs text-destructive">Limit reached — resets next Monday.</p>}
                    </div>
                  )}
                  {acct !== "admin" && (
